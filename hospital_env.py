...
class HospitalEnv(object):
    ...
    def __init__(self,
        ...
        # Clip the arrival distribution to be 0 to maximum capacity 避免等待人数多于100
        self.arrival_distrib = np.clip(arrival_distrib, 0, waiting_capacity)

        # Define the state space and action space
        self.state_space = np.arange(waiting_capacity + 1)#[0,1, ... , waiting_capacity]
        self.action_space = np.arange(max_on_demand_doc + 1)#[0,1, ... , max_on_demand_doc]
